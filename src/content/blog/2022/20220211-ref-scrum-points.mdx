...
***Update: 2023:** Understanding and perceptions around Agile and Scrum practices have been so convoluted that I no
longer want to be associated with them. The [agile manifesto](https://agilemanifesto.org/principles.html) is still
good. However, the attempted applications of it in larger organizations and consultancies? ...not so much.*
