...
<figure class="figure">
  ...
  <figcaption class="figure-caption text-center">
    <span>
      360° photo from <a href="https://webxr-tests-3.kaliatech.com/test4">Test 4</a>
    </span>
  </figcaption>
</figure>
...
that space _seems_ to be a company called [Dreamcam](https://hub.dreamcam.com/en/wiki). They sell their live VR video
