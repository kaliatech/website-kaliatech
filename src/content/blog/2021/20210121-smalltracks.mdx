...
photos:
  [
    { src: '/i/blog/2021/smalltracks/tanktreads-2021019-bw.webp', caption: 'Example trank tracks' },
    { src: '/i/blog/2021/smalltracks/3dprint2-180-bw.webp', caption: 'Printed in flexible TPU' },
    {
      src: '/i/blog/2021/smalltracks/scrshot-20210119-bw.webp',
      caption: 'Interactive 3D Visualization',
    },
    { src: '/i/blog/2021/smalltracks/scrshot-20210119-b-bw.webp', caption: 'Multiple parameters' },
  ]
---
...
<figure>
  <a href="/i/blog/2021/smalltracks/smalltracks-triangles.webp">
    <img
      src="/i/blog/2021/smalltracks/smalltracks-triangles.webp"
      class="figure-img"
...
- [ ] Rework UI, especially the parameters UI &lt;--- until this is done, I'm almost embarrassed to show the site
