...
export const photosEvernoteEncrypted = [
  {
...
**UPDATE [2024]:** _Since writing the post below, I have switched over to [Obsidian](https://obsidian.md/) entirely and have
been using it for over two years now. I pay for their sync service which lets me use it easily on all devices. I use a
number of plugins and have built-up multiple workflows around it. It's excellent._
...
<BlogPhotosSimple photos={photosNotebooks} cols={3} />
...
<BlogPhotosSimple photos={photosNoteshelf} cols={3} />
...
<BlogPhotoSimple photo={photosEvernoteEncrypted[0]} maxWidth={'35rem'} />
...
<BlogPhotoSimple photo={photosQuack[0]} maxWidth={'80%'} />
