<template>
  <BlogPost date="2019-05-21" title="3D Printer - Update">
    <div class="row">
      <div class="col">
        <p>Having had the 3D printer for a few months now, I can say it's easily one of my favorite purchases ever.</p>
      </div>
    </div>

    <h2>Recent Prints, Etc</h2>
    <div class="row">
      <div :key="photo.src" class="col-sm-6" v-for="photo in photos">
        <figure class="figure">
          <a :href="photo.src">
            <video
              :src="photo.src"
