<template>
  <ProjectDetail date="2018-10-31" title="Experiments with ARCore on Android">
    <p>
    ...
    <div>
      <img class="img-fluid rounded" src="~assets/i/projects/2018/1031-android-ar/ar-balloons-scrshot.png" />
    </div>
  </ProjectDetail>
</template>
