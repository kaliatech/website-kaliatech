<template>
  <ProjectDetail title="Particle Phone Experiments" date="2017-07">
    ...
    <p>
      ...
      <a href="https://www.particle.io/products/hardware/electron-cellular-dev-kit">Electron</a>, making the
      platform accessible anywhere there&#8217;s cellular coverage. Very cool.</p>
    <p>
      The Photon and Electron are great matches for Internet-of-Things (IoT) type ideas. IoT might be a buzzword,
      but even so, the related platforms and devices coming about to support IoT are opening up a whole new level of
      possibilities.
    </p>
    <!--@formatter:on-->
  </ProjectDetail>
