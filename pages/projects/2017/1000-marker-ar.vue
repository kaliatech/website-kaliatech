<template>
  <ProjectDetail date="2017-10-00" title="Marker Based AR in Browser">
    <p>
      Video showing a quick experiment with marker image based augmented reality in standard web browers. (Not
